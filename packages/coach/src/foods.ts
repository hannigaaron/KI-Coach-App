...
export interface FoodRef {
  key: string;
  /** Name fuer die Anzeige. Der Schluessel ist technisch und gehoert nie in die Oberflaeche. */
  label: string;
...
export const FOODS: FoodRef[] = [
  { key: "haehnchenbrust", label: "Haehnchenbrust", aliases: ["haehnchenbrust", "hähnchenbrust", "haehnchen", "hühnerbrust", "chicken"], per100: { kcal: 120, proteinG: 23, fatG: 2.6, carbsG: 0 }, state: "roh" },
  ...
  { key: "ei", label: "Ei", aliases: ["ei", "eier", "spiegelei", "ruehrei", "rührei"], per100: { kcal: 143, proteinG: 12.6, fatG: 9.5, carbsG: 0.7 }, pieceG: 58 },
  ...
  { key: "huettenkaese", label: "Huettenkaese", aliases: ["huettenkaese", "hüttenkäse", "koernigerfrischkaese"], per100: { kcal: 98, proteinG: 11, fatG: 4.3, carbsG: 3.4 } },
  ...
  { key: "gouda", label: "Gouda", aliases: ["gouda", "kaese", "käse"], per100: { kcal: 356, proteinG: 25, fatG: 28, carbsG: 0 } },
  ...
  { key: "suesskartoffel", label: "Suesskartoffel", aliases: ["suesskartoffel", "süßkartoffel", "sweet potato"], per100: { kcal: 86, proteinG: 1.6, fatG: 0.1, carbsG: 20 }, state: "gekocht" },
  ...
  { key: "apfel", label: "Apfel", aliases: ["apfel", "aepfel", "äpfel"], per100: { kcal: 52, proteinG: 0.3, fatG: 0.2, carbsG: 14 }, pieceG: 180 },
  ...
  { key: "olivenoel", label: "Olivenoel", aliases: ["olivenoel", "olivenöl", "oel", "öl"], per100: { kcal: 884, proteinG: 0, fatG: 100, carbsG: 0 } },
  { key: "butter", label: "Butter", aliases: ["butter"], per100: { kcal: 717, proteinG: 0.9, fatG: 81, carbsG: 0.1 } },
  { key: "mandeln", label: "Mandeln", aliases: ["mandeln", "nuesse", "nüsse"], per100: { kcal: 579, proteinG: 21, fatG: 50, carbsG: 22 } },
  ...
  { key: "doener", label: "Doener", aliases: ["doener", "döner", "kebab"], per100: { kcal: 215, proteinG: 14, fatG: 10, carbsG: 17 }, state: "zubereitet" },
